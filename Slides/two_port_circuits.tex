...
\begin{frame}[allowframebreaks]{Complex numbers \& Trigonometric functions}
...
\begin{columns}
	...
	\includegraphics[width=\textwidth]{/Users/gsw/github/F429/potencia_instantanea_phi0.pdf}
	\center{	$\phi=0^\circ$}
	\end{column}
	\pause
	\begin{column}{0.33\textwidth}
	\includegraphics[width=\textwidth]{/Users/gsw/github/F429/potencia_instantanea_phi45.pdf}
		\center{	$\phi=0^\circ$}
	\end{column}
	\pause
	\begin{column}{0.33\textwidth}
	\includegraphics[width=\textwidth]{/Users/gsw/github/F429/potencia_instantanea_phi90.pdf}
		\center{	$\phi=90^\circ$}
	\end{column}
\end{columns}
...
Test\hyperlink{two-port}{\beamerbutton{here}}.
\end{frame}
