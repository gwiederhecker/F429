...
\newcommand{\ic}{\textit{Instrument Control Toobox}\textsuperscript{\textregistered}}
\newcommand{\str}{\textit{strings}}
...
%medidas com erro
\newcommand{\mede}[4]{${#1}$={#2}$\pm${#3}{#4}}
\newcommand{\med}[3]{${#1}$={#2}{#3}}
%erros
\newcommand{\dm}[3]{$\delta$\text{{#1}}={#2}{#3}}
...
\newcommand{\nF}{~nF}
%HEADERS
\newcommand{\pT}{\paragraph{Teoria}}
\newcommand{\pE}{\paragraph{Procedimento Experimental}}
%\newcommand{\ml}{Matlab\textsuperscript{\textregistered} }
\newcommand{\mta}{Mathematica\textsuperscript{\textregistered} }
%\newcommand{\sinn}{Si$_3$N$_4$\text{ }}
%\newcommand{\sio}{SiO$_2$\text{ }}
...
%complex exponentinal
\newcommand{\ejt}{\exp j\omega t}
%------------------------------------------
%			TWO PORT NETWORK
%------------------------------------------
\newcommand{\tpn}[2]{
